...
ytcfg.set({
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20241113.07.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "hl": "ar",
            "gl": "DZ",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20241113.07.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    var policy = self.trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(unused) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/508deff1\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(policy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/508deff1\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}